...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Nov 2024 pada 04.27
...
--
DELIMITER $$
CREATE TRIGGER `log` AFTER INSERT ON `gejala` FOR EACH ROW INSERT INTO log_aktifitas VALUES ('', new.gejala, "tambah_data", now())
$$
DELIMITER ;
